...
import com.example.sqliteinsert.UserContract.UserEntity;
...
public class PetProvider extends ContentProvider {
    ...
    private int updateUser(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        return database.update(UserEntity.TABLE_NAME, values, selection, selectionArgs);
    }
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            case USERS:
                ...
                return database.delete(UserEntity.TABLE_NAME, selection, selectionArgs);
            case USER_ID:
